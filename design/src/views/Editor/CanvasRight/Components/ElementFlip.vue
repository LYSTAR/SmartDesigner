<template>
  <el-row>
    <el-checkbox-group class="full-group" v-model="handleFlip" @change="changeElementFlip">
      <el-checkbox-button value="flipY"> <IconFlipVertically />{{ $t('style.flipVertical') }} </el-checkbox-button>
      <el-checkbox-button value="flipX"> <IconFlipHorizontally />{{ $t('style.flipHorizontal') }} </el-checkbox-button>
    </el-checkbox-group>
  </el-row>
</template>
